...
$rasm = "Сотиладиган буюм расмини юборинг!"; // rasm yuborishi sorash txtsi
function del($nomi){
...
$manzil = json_encode(
['inline_keyboard' => [
[['callback_data' => "Бухоро Ш", 'text' => "Бухоро Ш"],['callback_data' => "Бухоро Т", 'text' => "Бухоро Т"],],
[['callback_data' => "Когон Ш", 'text' => "Когон Ш"],['callback_data' => "Когон Т", 'text' => "Когон Т"],],
[['callback_data' => "Жондор", 'text' => "Жондор"],['callback_data' => "Ромитан", 'text' => "Ромитан"],],
[['callback_data' => "Олот", 'text' => "Олот"],['callback_data' => "Пешку", 'text' => "Пешку"],],
[['callback_data' => "Коракул", 'text' => "Коракул"],['callback_data' => "Коравул Бозор", 'text' => "Коравул Бозор"],],
[['callback_data' => "Гиждувон", 'text' => "Гиждувон"],['callback_data' => "Шофиркон", 'text' => "Шофиркон"],],
[['callback_data' => "Вопкен", 'text' => "Вопкен"],],
]
]);
...
bot('sendMessage',[
'chat_id'=>$admin,
'text'=>"<b>Янги эълон келди:</b>
Id: $cbid
Username: @$cbuser
<a href='tg://user?id=$cbid'>Захиравий профилга кириш</a><code>$baza
